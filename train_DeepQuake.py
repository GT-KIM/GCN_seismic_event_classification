...
class FeatureExtraction(nn.Module) :
    def __init__(self) :
        ...
        self.conv1 = nn.Conv1d(3, 64, 3, 2, 0)
        self.conv2 = nn.Conv1d(64, 64, 3, 2, 0)
        self.conv3 = nn.Conv1d(64, 64, 3, 2, 0)
        self.conv4 = nn.Conv1d(64, 64, 3, 2, 0)
        self.conv5 = nn.Conv1d(64, 64, 3, 2, 0)
        self.conv6 = nn.Conv1d(64, 64, 3, 3, 0)
    ...
    def forward(self, feature) :
        ...
        outputs = F.relu(self.conv6(feature))
